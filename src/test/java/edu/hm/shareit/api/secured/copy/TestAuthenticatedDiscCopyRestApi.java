 ...
 */
public class TestAuthenticatedDiscCopyRestApi {
    ...
    @Test
    public void testBorrowDisc() {
        Response response = ClientBuilder.newClient()
                .target(SECURED_COPIES_URL_TO_TEST + "discs/01234567890123")
    ...
    @Test
    public void testListDiscCopies() {
        Response response = ClientBuilder.newClient()
                .target(SECURED_COPIES_URL_TO_TEST + "discs")
                .request(MediaType.APPLICATION_JSON)
                .header(HttpHeaders.AUTHORIZATION, testToken)
                .get();
...
*/
    ...
    public void testReturnBook() {
        Response response = ClientBuilder.newClient()
                .target(SECURED_COPIES_URL_TO_TEST + "discs/9876543210987")
                .request(MediaType.APPLICATION_JSON)
                .header(HttpHeaders.AUTHORIZATION, testToken)
                .put(Entity.json(new Disc("Das Sams", "0192837465012", "Hans Müller", 12)));
